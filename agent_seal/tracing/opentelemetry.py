...
agent-seal pipeline (``llm_calls`` table + audit trail hash-chain).
...
logger = logging.getLogger("agent_seal.tracing.otel")


class AuditSpanProcessor:
    """Bridge between OpenTelemetry spans and agent-seal storage.
    ...
    Usage::
        ...
        from agent_seal.tracing import AuditSpanProcessor
