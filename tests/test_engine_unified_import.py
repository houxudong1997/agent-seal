"""Tests for agent_audit.engine — unified import module validation.
...
class TestReexportedSymbols:
    ...
    def test_audit_store_importable(self):
        from agent_audit.engine import AuditStore
...
class TestExportIdentity:
    ...
    def test_audit_engine_identity(self):
        from agent_audit.core.storage import AuditEngine as Source
        from agent_audit.engine import AuditEngine as ReExported

        assert ReExported is Source

    def test_audit_store_identity(self):
        from agent_audit.core.storage import AuditStore as Source
        from agent_audit.engine import AuditStore as ReExported

        assert ReExported is Source

    def test_create_store_identity(self):
        from agent_audit.core.storage import create_store as source
        from agent_audit.engine import create_store as re_exported

        assert re_exported is source

    def test_jsonl_store_identity(self):
        from agent_audit.core.storage import JSONLStore as Source
        from agent_audit.engine import JSONLStore as ReExported

        assert ReExported is Source

    def test_sqlite_store_identity(self):
        from agent_audit.core.storage import SQLiteStore as Source
        from agent_audit.engine import SQLiteStore as ReExported

        assert ReExported is Source

    def test_postgresql_store_identity(self):
        from agent_audit.core.storage import PostgreSQLStore as Source
        from agent_audit.engine import PostgreSQLStore as ReExported

        assert ReExported is Source

    def test_postgresql_store_orm_identity(self):
        from agent_audit.core.storage import PostgreSQLStoreORM as Source
        from agent_audit.engine import PostgreSQLStoreORM as ReExported

        assert ReExported is Source

    def test_signed_audit_engine_identity(self):
        from agent_audit.core.crypto import SignedAuditEngine as Source
        from agent_audit.engine import SignedAuditEngine as ReExported

        assert ReExported is Source

    def test_chain_event_identity(self):
        from agent_audit.core.chain import ChainEvent as Source
        from agent_audit.engine import ChainEvent as ReExported

        assert ReExported is Source

    def test_session_chain_identity(self):
        from agent_audit.core.chain import SessionChain as Source
        from agent_audit.engine import SessionChain as ReExported
...
class TestCreateStoreSignature:
    ...
    def test_create_store_returns_audit_store(self):
        ...
        from agent_audit.engine import JSONLStore, SQLiteStore, create_store
...
class TestAuditEngineInterface:
    ...
    def test_audit_engine_log_returns_chain_event(self):
        from agent_audit.engine import AuditEngine, ChainEvent
...
class TestModuleDocstring:
    ...
    def test_module_has_docstring(self):
        import agent_audit.engine as engine
