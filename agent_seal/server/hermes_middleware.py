"""
Hermes middleware — captures agent-seal events from Hermes agent interactions.

This FastAPI middleware intercepts requests routed through agent-seal's
...
Features:
  ...
  - Communicates with agent-seal's own AuditEngine for recording
...
def _resolve_agent_id() -> str:
    ...
    Priority:
        1. AGENT_SEAL_HERMES_AGENT_ID
        2. HERMES_AGENT_ID
        3. HERMES_PROFILE
        4. "unknown-hermes-agent" (fallback)
    """
    return (
        os.environ.get("AGENT_SEAL_HERMES_AGENT_ID")
