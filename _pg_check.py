...
os.environ["AGENT_AUDIT_DB_URL"] = "postgresql://audit:audit_dev@127.0.0.1:5432/agent_audit"

try:
    import psycopg2
    conn = psycopg2.connect("postgresql://audit:audit_dev@127.0.0.1:5432/agent_audit")
    cur = conn.cursor()
