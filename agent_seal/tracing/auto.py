...
Respects the ``AGENT_SEAL_AUTO_TRACE`` environment variable.
...
logger = logging.getLogger("agent_seal.tracing.auto")
...
def _auto_enabled() -> bool:
    val = os.getenv("AGENT_SEAL_AUTO_TRACE", "").strip().lower()
